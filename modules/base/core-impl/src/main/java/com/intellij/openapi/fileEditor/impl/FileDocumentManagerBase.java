...
public abstract class FileDocumentManagerBase extends FileDocumentManager {
  ...
  @Nonnull
  private CharSequence loadText(@Nonnull VirtualFile file, boolean tooLarge) {
    if (file instanceof LightVirtualFile) {
  ...
  @Nonnull
  protected abstract Document createDocument(@Nonnull CharSequence text, @Nonnull VirtualFile file);
  ...
  protected void unbindFileFromDocument(@Nonnull VirtualFile file, @Nonnull Document document) {
