...
public final class ProgressRunner<R> {
  ...
  @NotNull
  private CompletableFuture<R> execFromEDT(@NotNull CompletableFuture<? extends ProgressIndicator> progressFuture, @NotNull Semaphore modalityEntered, @NotNull Supplier<R> onThreadCallable) {
  ...
  @NotNull
  private CompletableFuture<R> normalExec(@NotNull CompletableFuture<? extends ProgressIndicator> progressFuture, @NotNull Semaphore modalityEntered, @NotNull Supplier<R> onThreadCallable) {
